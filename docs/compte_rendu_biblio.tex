...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{09_user_workflow.png}
    \caption{Flux de Navigation et Parcours Utilisateur}
...
\subsection{Flux d'Installation et Démarrage}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{12_installation.png}
    \caption{Processus d'Installation et de Démarrage du Projet}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{06_stock_flow.png}
    \caption{Système de Stock Double - Flux de Gestion}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{04_loan_states.png}
    \caption{Machine à États du Statut des Prêts}
    \label{fig:loan_states}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{10_calendar.png}
    \caption{Vue du Calendrier de Disponibilité des Livres}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{05_order_states.png}
    \caption{Machine à États du Statut des Commandes}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{13_payment_flow.png}
    \caption{Flux de Paiement Stripe Intégré}
...
\subsubsection{Vue d'Ensemble de l'Administration}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{11_admin_dashboard.png}
    \caption{Structure du Tableau de Bord Administrateur}
...
\subsubsection{Stratégie de Migration du Stock}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{14_migration.png}
    \caption{Stratégie de Migration du Système de Stock Double}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{15_security.png}
